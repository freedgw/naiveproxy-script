...
installProxy(){
    ...
    rm -f /usr/bin/caddy
    wget https://github.com/lxhao61/integrated-examples/releases/download/20221017/caddy-linux-$(archAffix).tar.gz -O /usr/bin/caddy.tar.gz
    tar -xvf /usr/bin/caddy.tar.gz -C /usr/bin
    mv /usr/bin/caddy
